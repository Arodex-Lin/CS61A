...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score = take_turn(roll,score1,dice)
            if feral_hogs:
                if abs(roll - last1) ==2:
                    score0 = score0 + 3 
            score0 = score0 + score 
            ...
            score = take_turn(roll,score0,dice)
            if feral_hogs:
                if abs(roll - last2) ==2:
                    score1 = score1 + 3 
            score1 = score1 + score 
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        if score - last_score > run:
            run = score - last_score
            print(run ,"point(s)! That's the biggest gain yet for Player",who)
        return announce_highest(who , score, run)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max = -1
    index = -1
    scorefunction = make_averaged(roll_dice,trials_count)
    for i in range(1,11):
        score = scorefunction(i, dice)
        if score > max:
            max = score
            index = i
    return index
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return swap_strategy(score , opponent_score,cutoff= 5, num_rolls =6)
    # END PROBLEM 12
